...
<div class="container-fluid">
    ...
    <div class="col-sm-12 col-md-3 col-lg-4 pt-4 "> <img src="/img/servicio.jpeg" class="img-fluid"alt="" class="justify-content-center"></div>
    <div class="col-sm-12 col-md-4 col-lg-4 pt-4  "> <img src="/img/servicio.jpeg" class="img-fluid"alt="" class="justify-content-center"></div>

    <div class="col-sm-12 col-md-3 col-lg-3 pt-4 "><img src="/img/servicio.jpeg" class="img-fluid"alt="" class="justify-content-center"> </div>
