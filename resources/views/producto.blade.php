...
<div class="container-fluid">
    <div class="row pt-4">
    <div class="col-sm-12 col-md-4 col-lg-4 pt-4 "></div>

    <div class="col-sm-12 col-md-4 col-lg-4 pt-4 "> 
    <a href="/catalogo"><button class="btn btn-large btn-success btn-lg mb-2 " type="submit">ver catalogo</button></a>
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/img/perfumeria.jpg" class="d-block w-100" alt="...">
    </div>
